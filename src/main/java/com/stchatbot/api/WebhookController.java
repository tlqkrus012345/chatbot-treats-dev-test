...
import com.stchatbot.config.TokenConfig;
...
import com.stchatbot.api.SendInvalidTokenMessage;

import static com.stchatbot.api.WebhookController.EventType.*;
import static com.stchatbot.api.WebhookController.InputKeyword.*;
    ...
    public ResponseEntity<?> webhook(@RequestBody String callback) {
        ...
        if (event.equals(MESSAGE)) {
            ...
            if (isValidToken) {
                ...
                return sendInvalidTokenMessage.execute(accountId);
            }
        }
        return null;
    }
